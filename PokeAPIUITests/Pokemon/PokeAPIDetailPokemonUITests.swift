...
final class PokeAPIDetailPokemonUITests: XCTestCase {
    ...
    private let identifierCollapsePokemonDetailGameIndices = "collapsePokemonDetailGameIndices"
    ...
    func test_press_on_first_pokemon_and_check_exist_info() throws {
        ...
        let collapsePokemonDetailGameIndices = app.staticTexts[identifierCollapsePokemonDetailGameIndices]
